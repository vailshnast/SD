...
public class Reward_Tooltip : MonoBehaviour
{
    #region Variables
    ...
    private void Information_Set(Data_Item_Reward data_item)
    {
    ...
    private void Panel_Processor(Data_Item_Reward data_item)
    {
    ...
    public void Activate(Data_Item_Reward data_item)
    {
    ...
    public Data_Item_Reward getItem()
    {
        return item;
    }
    ...
    public void DestroyItem(Data_Item_Reward data_item)
    {
    ...
    {
        FindObjectOfType<Button_Proccesor_Reward>().ScrollIsUsed = false;
