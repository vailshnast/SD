...
public class Explore_Tooltip : MonoBehaviour {

    private Inventory_Explore inventory;
    private GameObject tooltip;
    private GameObject panel_tooltip;
    
    private Data_Item_Explore item;
    ...
    private void Init()
    {
        ...
        tooltip = getChild(gameObject, "Tooltip_Explore");

        panel_tooltip = getChild(gameObject, "Panel_tooltip");

        name_item = getChild(gameObject, "Tooltip_Name");
        description_item = getChild(gameObject, "Tooltip_Description");

        torchPanel = GameObject.Find("Torch_Panel");
        hp_mana_Panel = GameObject.Find("HP_MANA_Panel");
    ...
    private void Information_Set(Data_Item_Explore data_item)
    {
        description_item.GetComponent<Text>().text = data_item.item.Description;
        name_item.GetComponent<Text>().text = data_item.item.Title;
       
        getChild(tooltip, "Tooltip_Sprite").GetComponent<Image>().sprite = data_item.item.GetSprite();
        Panel_Processor(data_item);
    }
    private void Panel_Processor(Data_Item_Explore data_item)
    {
    ...
    public void Activate(Data_Item_Explore data_item)
    {
    ...
    public void Activate(Item item)
    {
        ...
        getChild(tooltip, "Tooltip_Sprite").GetComponent<Image>().sprite = item.GetSprite();
    ...
    public Data_Item_Explore getItem()
    {
        return item;
    }
    ...
    public void DestroyItem(Data_Item_Explore data_item)
    {
    ...
    {
        FindObjectOfType<Button_Proccesor>().ScrollIsUsed = false;
