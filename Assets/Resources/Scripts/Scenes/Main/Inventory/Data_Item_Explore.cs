...
public class Data_Item_Explore : MonoBehaviour, IBeginDragHandler, IDragHandler, IEndDragHandler, IPointerClickHandler
{
    ...
    public Explore_Tooltip tooltip;
    ...
    void Start()
    {
        inventory = GameObject.Find("Inventory").GetComponent<Inventory_Explore>();
        button_Proccesor = FindObjectOfType<Button_Proccesor>();
        tooltip = gameObject.transform.parent.parent.parent.parent.parent.GetComponent<Explore_Tooltip>();
    }
