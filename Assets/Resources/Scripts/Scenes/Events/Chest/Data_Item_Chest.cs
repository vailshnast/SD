...
public class Data_Item_Chest : MonoBehaviour, IBeginDragHandler, IDragHandler, IEndDragHandler, IPointerClickHandler
{
    ...
    void Start()
    {
        ...
        tooltip = FindObjectOfType<Chest_Tooltip>();
    }
