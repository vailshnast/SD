...
public class Sack_Tooltip : MonoBehaviour
{
    #region Variables
    ...
    private void Init()
    {
        ...
        tooltip = transform.getChild(gameObject, "Tooltip_Sack");


        name_item = transform.getChild(gameObject, "Tooltip_Name");
        description_item = transform.getChild(gameObject, "Tooltip_Description");
    ...
    private void Information_Set(Data_Item_Sack data_item)
    {
    ...
    private void Panel_Processor(Data_Item_Sack data_item)
    {
    ...
    public void Activate(Data_Item_Sack data_item)
    {
    ...
    public void DestroyItem(Data_Item_Sack data_item)
    {
    ...
    {
        FindObjectOfType<Button_Proccesor_Sack>().ScrollIsUsed = false;
