...
public class Data_Item_Sack : MonoBehaviour, IBeginDragHandler, IDragHandler, IEndDragHandler, IPointerClickHandler
{
    ...
    void Start()
    {
        ...
        tooltip = FindObjectOfType<Sack_Tooltip>();
