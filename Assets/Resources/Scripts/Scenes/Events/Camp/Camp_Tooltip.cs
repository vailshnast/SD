...
public class Camp_Tooltip : MonoBehaviour
{
    #region Variables
    [HideInInspector]
    public Inventory_Camp inventory;
    [HideInInspector]
    public GameObject tooltip;
    private GameObject panel_tooltip;

    private Data_Item_Camp item;
    ...
    private void Information_Set(Data_Item_Camp data_item)
    {
    ...
    private void Panel_Processor(Data_Item_Camp data_item)
    {
    ...
    public void Activate(Data_Item_Camp data_item)
    {
    ...
    public void DestroyItem(Data_Item_Camp data_item)
    {
    ...
    {
        FindObjectOfType<Button_Proccesor_Camp>().ScrollIsUsed = false;
