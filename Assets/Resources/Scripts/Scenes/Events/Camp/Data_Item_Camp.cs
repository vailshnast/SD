...
public class Data_Item_Camp : MonoBehaviour, IBeginDragHandler, IDragHandler, IEndDragHandler, IPointerClickHandler
{
    ...
    void Start()
    {
        inventory = FindObjectOfType<Inventory_Camp>();

        button_Proccesor = FindObjectOfType<Button_Proccesor_Camp>();
        tooltip = FindObjectOfType<Camp_Tooltip>();
    }
